...
ActiveRecord::Schema.define(version: 20171128101019) do
  ...
  create_table "recording_tags", force: :cascade do |t|
    ...
    t.datetime "created_at",   null: false
    t.datetime "updated_at",   null: false
    t.index ["recording_id"], name: "index_recording_tags_on_recording_id", using: :btree
    t.index ["tag_id"], name: "index_recording_tags_on_tag_id", using: :btree
  end
